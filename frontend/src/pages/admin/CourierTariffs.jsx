    ...
    <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-10 space-y-6 max-w-5xl mx-auto">
      ...
      >
        <div className="sm:col-span-2">
          ...
          <input
            type="text"
            className="w-full border border-neutral-200 dark:border-neutral-700 rounded px-3 py-2 text-sm bg-white dark:bg-neutral-800 text-matte dark:text-ivory focus:outline-none focus:ring-1 focus:ring-gold"
                ...
                {tariffs.map((t) => (
                  ...
                  >
                    ...
                    <td className="py-2 pr-4">
                      <span
                        className={`px-2 py-0.5 rounded-full text-[11px] ${t.active
